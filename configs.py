...
parser.add_argument('--valid_path', type=str, default='../GTSRB/Valid',
                    help='验证集路径')
# parser.add_argument('--train_path', type=str, default='G:/Python_project/RP2/GTSRB_model/Train(tiny)',
#                     help='主机上用于调试的小训练数据集路径')
...
# parser.add_argument('--model_path', type=str,
#                     default='model_backup/backup2/fine_tune_model_13.pth',
#                     help='结构+参数路径')
# parser.add_argument('--model_param_path', type=str,
#                     default='model_backup/backup2/fine_tune_model_param_13.pth',
#                     help='用于分类的模型路径')
